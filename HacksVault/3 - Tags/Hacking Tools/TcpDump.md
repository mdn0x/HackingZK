...
```shell-session
mdn0x@htb[/htb]$ sudo apt install tcpdump 
```
...
```shell-session
mdn0x@htb[/htb]$ sudo tcpdump --version
...
```shell-session
mdn0x@htb[/htb]$ sudo tcpdump -i eth0
...
```shell-session
mdn0x@htb[/htb]$ sudo tcpdump -i eth0 -nn
...
```shell-session
mdn0x@htb[/htb]$ sudo tcpdump -i eth0 -e
...
```shell-session
mdn0x@htb[/htb]$ sudo tcpdump -i eth0 -X
...
```shell-session
mdn0x@htb[/htb]$ sudo tcpdump -i eth0 -nnvXX
...
```shell-session
mdn0x@htb[/htb]$ sudo tcpdump -i eth0 -w ~/output.pcap
...
```shell-session
mdn0x@htb[/htb]$ sudo tcpdump -r ~/output.pcap
